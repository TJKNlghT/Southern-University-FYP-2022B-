    ...
    <div class="page-wrapper chiller-theme toggled">
        ...
        <main class="page-content">
            <div class="container-fluid">
                <table class="table">
                    <div class="d-flex justify-content-between"><h2>Edit: {{$categories->name}}</h2> &nbsp;<button class="btn btn-primary"><a href="{{ route('viewAdminCategory') }}" class="pt-4 previous">Back</a></button></div>
              <hr>
              <div class="row">
