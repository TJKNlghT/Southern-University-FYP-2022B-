    ...
    <div class="page-wrapper chiller-theme toggled">
        ...
        <main class="page-content">
            <div class="container-fluid">
                <table class="table">
                    <div class="d-flex justify-content-between"><h2>Add Custom Menu Items</h2> &nbsp;<button class="btn btn-primary"><a href="{{ route('viewAdminCustomProduct') }}" class="pt-4 previous">Back</a></button></div>
              <hr>
              <div class="row">
                <form method="POST" action="{{ route('addCustomProduct') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6 pb-3">
