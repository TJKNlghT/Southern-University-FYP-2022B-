                ...
                @foreach($orderhistory as $orderhistorys)
                    <div class="row">
                        <div class="col-12 d-flex">
                            <div class="col-4 text-start"><a href="{{ route('orderhistory') }}" class="previous">&laquo; Back</a></div>
                            <div class="col-8 text-end"><h5>Past Order Receipt</h5></div>
                        </div>
                        <hr>
                        <div class="col-12 d-flex justify-content-between">
                            ...
                            <div>
                                <p>
                                    <em>Order No: <strong class="text-center text-danger">{{$orderhistorys->orderid}}</strong></em>
                                    <br>
